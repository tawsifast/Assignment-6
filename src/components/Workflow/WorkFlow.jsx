...
const WorkFlow = () => {
  return (
    <div>
      <div className="flex flex-col justify-center items-center space-y-7 bg-linear-to-r from-[#4F39F6] to-[#9514FA] p-15 text-white">
        <h1 className="font-bold text-2xl text-center md:text-3xl">Ready to Transform Your Workflow?</h1>
